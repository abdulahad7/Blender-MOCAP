...
class PoseEstimation(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi('./src/ui.ui', self) # Load the .ui file
       ...
       # _capture.clicked.connect(self.clicked())
        ...
        self._threhold.setChecked(True)
    ...
    def capture(self):
        ...
        self.e = TfPoseEstimator(get_graph_path(self._comboBox.currentText()), target_size=(w, h))
